...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQueryDict) -> Response:
        """
        Метод на получение списка заданий для определенного курса
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestDict) -> Response:
        ...
        :param exercise_id: Идентификатор задания
        :param request: Словарь с с title, maxScore, minScore, orderIndex, description, estimatedTime
        :return: Ответ от сервера в виде объекта httpx.Response
        """
    ...
    def update_exercise(self, exercise_id: str, request: UpdateExerciseRequestDict) -> Exercise:
        response = self.get_exercise_api(exercise_id, request)
        return response.json()
